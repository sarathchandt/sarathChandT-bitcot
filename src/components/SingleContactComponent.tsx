    ...
    <div className="mb-1 px-4">
      <div className="bg-white rounded-[10px] flex flex-row justify-between ">
        ...
        <div className="md:w-6/12 w-7/12 flex py-2 flex-row gap-4">
          <div className="md:h-10 h-6 md:w-10 w-6 my-auto ">
            <svg
        ...
        <div className="w-4/12 flex flex-row md:gap-4 gap-3">
          <div
            className="md:h-7 h-4 md:w-7 w-4 my-auto "
          ...
          <div className="md:h-7 h-4 md:w-7 w-4 my-auto " onClick={onEditClick}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="md:h-7 h-4 md:w-7 w-4 my-auto cursor-pointer" onClick={onDeleteClick}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
